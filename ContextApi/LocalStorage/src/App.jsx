...
import { TodoContextProvider } from './assets/context/TodoContext.js';
...
function App() {
  ...
  const toggleComplete = (id) => {setTodos(prev => prev.map(indTodo => indTodo.id === id ? {...indTodo, completed: !indTodo.completed} : indTodo))}
